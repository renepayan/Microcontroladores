...
;..............................................................................
    ...
    .GLOBAL __INT0Interrupt  ;La interrupcion 0
;..............................................................................
...
LETTER_AU_PM:
    .WORD 0x0008, 0x0030, 0x004F, 0x0001, 0x0041, 0x0000
	
LETTER_UA_PM:
    .WORD 0x0041, 0x0001, 0x004F, 0x0030, 0x0008, 0X0000
...
obtenerValoresDeMemoriaEImprimirEnF:    
	...
	;COM         W4, W4
	MOV	    W4, PORTF					;si no es cero, entonces cargamos el valor de W4 al puerto F		
	MOV	    W5, W0					;Le regresamos a W0 el valor del sleep (despues del primer ciclo se pierde)
	CALL	    delay_ms					;Detener n*1ms donde n esta en W0
	BRA	    A1_obtenerValoresDeMemoriaEImprimirEnF	;Ejecutamos de nuevo el ciclo de lectura
...
__INT0Interrupt:
    ...
    MOV #15, W0  
    CALL delay_ms                 
    CP W8, #7	;Ya se va a salir
    BRA Z, regresar_0 ;Ir a una rutina que lo regrese a 0
    BRA NZ,aumentar_1 ;Aumentarle uno a W6
    regresar_0:
	CLR W8	
	CALL SALIR_INTERRUPCION
    aumentar_1:
	ADD #1, W8	
    SALIR_INTERRUPCION:	
	POP W0
